...
data class FeedAddOrUpdate(val email:String="", val provider_id:String="", val login_type:String, val imguri:String, val content:String, val create_date:String)
...
data class QAAddOrUpdate(val email:String="", val provider_id:String="", val login_type:String, val imguri:String, val title:String, val content:String)
